...
Revision ID: da4dbe8bbd20
Revises: 
Create Date: 2022-10-31 04:58:23.841446
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_response_response_id'), 'response', ['response_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_response_response_id'), table_name='response')
